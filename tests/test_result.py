...
def test_sopn_day(template_sorter, election_date_template_sorter):
    ...
    assert first_election_date_template_sorter.sections[0].weight == -6000
    assert first_election_date_template_sorter.sections[0].mode is None
    assert first_election_date_template_sorter.sections[1].weight == 1000
    ...
    assert second_election_date_template_sorter.sections[0].weight == -6000
    assert (
        second_election_date_template_sorter.sections[0].mode
        == "List of candidates published"
    )
    assert second_election_date_template_sorter.sections[1].weight == -1000
    assert (
