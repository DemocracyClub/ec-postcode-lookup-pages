...
def get_no_parish_councils_block(country, in_london):
    if country == Country.ENGLAND:
        if not in_london:
            return _(
                "We don't provide information about town or parish council elections."
            )
    elif country == Country.SCOTLAND:
        return _(
            "We don't provide information about community council elections."
        )
    elif country == Country.WALES:
        return _(
            "We don't provide information about town or community council elections."
        )
    return None
