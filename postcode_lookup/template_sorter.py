...
class BallotSection(BaseSection):
    ...
    def context(self):
        ...
        if self.referendum:
            ...
            context["sopn_publish_date"] = self.timetable.close_of_nominations
...
class TemplateSorter:
    ...
    def __init__(
        ...
        self.no_parish_councils_block = get_no_parish_councils_block(
            self.country, in_london
        )
